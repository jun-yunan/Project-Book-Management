...
export default function Home() {
    ...
    return (
        <main className="flex min-h-screen  items-center justify-between relative flex-wrap bg-gray-300">
            <img
                src="https://images.pexels.com/photos/1029141/pexels-photo-1029141.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
                className="w-full h-full object-cover"
            />
            <div className="w-full h-full absolute flex flex-wrap justify-center">
                {data?.books.map((book) => (
                    <div
                        key={book._id}
                        className="w-[250px] h-[450px] flex-shrink-0 bg-white bg-opacity-70 m-4 rounded-xl shadow-xl"
                    >
